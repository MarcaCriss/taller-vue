<template>
  <div class="bg-white max-w-md rounded mt-4 m-auto p-4 overflow-hidden shadow-lg">
    ...
    <button class="p-3 px-4 font-bold text-white rounder-lg bg-green-400" @click="login">Login</button>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      login(){
        ...
        .catch((error) => {
          alert('Oops algo salio mal' + error.meessage);
        })
      }
    }
  }
